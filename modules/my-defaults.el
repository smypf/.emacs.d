...
(use-package emacs
  :ensure nil
  ;; I never use fill-column
  :bind ([remap set-fill-column] . find-file)
  :config
  ...
  ;; Slack's jump to is bound to "CMD + K". I don't like that this kills the current buffer.
  (define-key global-map (kbd "s-k") nil)
